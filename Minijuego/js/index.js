...
function algorithmEnemy2() {
  ...
  var enemy2_x = Number(enemy.getAttribute('data-x'))
  var enemy2_y = Number(enemy.getAttribute('data-y'))

  var incr_x = (player_x > enemy2_x ? -1 : 1)
  var incr_y = (player_y > enemy2_y ? -1 : 1)
